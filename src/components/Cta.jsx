export default function Cta () {
    return <div className="container call-to-action py-5">
              <ul className="cta-navbar d-flex justify-content-between p-0 m-0">
                ...
                <li><a href="#"><img src="./src/assets/img/buy-comics-subscriptions.png" alt="" /><span className="ps-3">SUBSCRIPTION</span></a></li>
                <li><a href="#"><img src="./src/assets/img/buy-comics-shop-locator.png" alt="" /><span className="ps-3">COMIC SHOP LOCATOR</span></a></li>
                <li><a href="#"><img src="./src/assets/img/buy-dc-power-visa.svg" alt="" /><span className="ps-3">DC POWER VISA</span></a></li>
              </ul>
           </div>
}